...
`getKSTTodayRange()` — `api/index.js:130`
...
`getKoreanDate(dateString)` (`api/index.js:140`) — `Intl.DateTimeFormat('ko-KR', { timeZone: 'Asia/Seoul' })`로 "2026년 8월 15일 (금)" 만들기. 사람에게 보여줄 때만.
...
- 모듈에는 주입해서 쓴다 (`api/index.js:1084`).

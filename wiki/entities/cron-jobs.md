...
| 10:20 매일 | `20 10 * * *` | `api/index.js:2881` | 데일리 리포트 행 자동 생성 |
| 11:00 매일 | `0 11 * * *` | `api/index.js:3605` | 숙제 자동 생성. 정지 기간이면 건너뜀 |
| 14:00 평일 | `0 14 * * 1-5` | `textbookFeeModule.js:729` | 교재비 담당쌤 알림 — 하루치를 **묶어서 한 통** |
| 16:00 매일 | `0 16 * * *` | `api/index.js:716` | 방치된 상담 건 리마인드 (담임 → 없으면 원장) |
...
| 22:00 매일 | `0 22 * * *` | `api/index.js:2814` | 그날 진도 행에 `데일리리포트URL` 채우기 |
